...
//#define TEMP_SENSOR_BED 7 - RUSTY - Changed to 1 with Chineese silicon heater - change back when using lultzbot heater
 ...
 */
#define MAX_BED_POWER 226 // limits duty cycle to bed; 255=full current - Rusty changed from 206 to 226
